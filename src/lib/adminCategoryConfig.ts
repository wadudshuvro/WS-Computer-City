...
export const adminContentGroups: AdminContentGroup[] = [
  {
    ...
    items: [
      ...
      { name: 'Power Supply', slug: 'power-supply', description: 'PSU units', formMainCategory: 'power_supply' },
      { name: 'Computer Case', slug: 'computer-case', description: 'PC chassis', formMainCategory: 'computer_case' },
      { name: 'CPU Cooler', slug: 'cpu-cooler', description: 'Air & liquid CPU coolers', formMainCategory: 'cpu_cooler' },
