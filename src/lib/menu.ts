...
export const FALLBACK_MENU_TREE: MenuTreeItem[] = [
  ...
  },
  {
    ...
    children: [
      {
        id: 'fallback-acc-keyboard',
        name: 'Keyboard',
        slug: 'keyboard',
        level: 1,
        sortOrder: 0,
        href: '/products?category=accessories&sub=keyboard',
        categoryId: null,
        categorySlug: null,
        isVisible: true,
        hideArrow: true,
      ...
      {
        id: 'fallback-acc-mouse',
        name: 'Mouse',
        slug: 'mouse',
        level: 1,
        sortOrder: 1,
        href: '/products?category=accessories&sub=mouse',
        categoryId: null,
        categorySlug: null,
        isVisible: true,
        hideArrow: true,
      ...
      {
        id: 'fallback-acc-headphone',
        name: 'Headphone',
        slug: 'headphone',
        level: 1,
        sortOrder: 2,
        href: '/products?category=accessories&sub=headphone',
        categoryId: null,
        categorySlug: null,
        isVisible: true,
        hideArrow: true,
      ...
      {
        id: 'fallback-acc-webcam',
        name: 'Webcam',
        slug: 'webcam',
        level: 1,
        sortOrder: 3,
        href: '/products?category=accessories&sub=webcam',
        categoryId: null,
        categorySlug: null,
        isVisible: true,
        hideArrow: true,
